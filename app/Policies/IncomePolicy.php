...
class IncomePolicy
{
    ...
    {
        return $user->can('view income') && $user->id === $income->user_id;
    }
    ...
    {
        return $user->can('update income') && $user->id === $income->user_id;
    }
    ...
    {
        return $user->can('delete income') && $user->id === $income->user_id;
    }
